...
public class CustomDatePickerDialog {
	...
	private HashMap<Integer,String> dayOfWeekStr = new HashMap<Integer,String>();
	{
		...
		dayOfWeekStr.put(Calendar.SUNDAY, "周日");
		dayOfWeekStr.put(Calendar.MONDAY, "周一");
		dayOfWeekStr.put(Calendar.TUESDAY, "周二");
		dayOfWeekStr.put(Calendar.WEDNESDAY,"周三" );
		dayOfWeekStr.put(Calendar.THURSDAY, "周四");
		dayOfWeekStr.put(Calendar.FRIDAY, "周五");
		dayOfWeekStr.put(Calendar.SATURDAY, "周六");
	...
	private DatePicker.OnDateChangedListener mOnDateChangedListener = new DatePicker.OnDateChangedListener() {
		...
		public void onDateChanged(DatePicker arg0, int year, int monthOfYear, int dayOfMonth) {
		    ...
		    m_tv_selectdate.setText(year+"-"+monthOfYear+"-"+dayOfMonth+dayOfWeekStr.get(dayOfWeek));
		}
	};
	...
	private void initalView() {
		mCustomView = LayoutInflater.from(mContext).inflate(
				R.layout.lib_custom_datepicker, null);
		...
		m_tv_selectdate.setText(year+"-"+month+"-"+dayOfMonth+dayOfWeekStr.get(cal.get(Calendar.DAY_OF_WEEK)));
		...
		okBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				mListener.onDateChangeListener(mDatePicker.getYear(),
