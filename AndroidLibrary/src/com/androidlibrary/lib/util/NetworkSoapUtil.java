...
public class NetworkSoapUtil {
   ...
   */
  public String performLogin(String methodName, String resultKey, String userNameKey,
      String userName, String passwordKey, String password) {
   ...
   */
  public String getWeatherByCityName(String theCityNameKey, String theCityName, String methodName,
      String resultKey) {
